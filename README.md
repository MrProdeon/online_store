...
Класс наследуется от абстрактного класса OrderCategory.  
Какого-то необходимого характера наследование не несёт и было сделано в учебных целях.
...
Представлен абстрактный класс BaseProduct для создания классов Product с обязаетельными методами  
для добавления нового продукта, получения и изменения цены.  
...
Класс Product использует миксин для отображения технической
информации в консоль при инициализации объекта.
...
Содержит класс Order, который характеризует полученный заказ в интернет-магазине.  
Имеет информацию с примечанием к заказу, объект продукта, цену и количество товара в заказе.  
Умеет рассчитывать стоимость заказа и отображать строковое представление. 

Наследуется от абстрактного класса OrderCategory чисто в учебных целях.
...
print(order)
>>>
Состав заказа : Банан, в количестве 2шт; общая стоимость 200
